...
<feed xmlns="http://www.w3.org/2005/Atom" xml:lang="<?php echo context::global_filter($core->blog->settings->system->lang,0,0,0,0,0,'BlogLanguage'); ?>">
...
<?php while ($_ctx->comments->fetch()) : ?>
  ...
  <entry>
    ...
    <published><?php echo context::global_filter($_ctx->pings->getISO8601Date(''),0,0,0,0,0,'PingDate'); ?></published>
    <updated><?php echo context::global_filter($_ctx->pings->getISO8601Date('upddt'),0,0,0,0,0,'PingDate'); ?></updated>
  ...
  <entry>
    ...
    <published><?php echo context::global_filter($_ctx->comments->getISO8601Date(''),0,0,0,0,0,'CommentDate'); ?></published>
    <updated><?php echo context::global_filter($_ctx->comments->getISO8601Date('upddt'),0,0,0,0,0,'CommentDate'); ?></updated>
