...
<head>
  ...
  <?php if($_ctx->posts->trackbacksActive()) : ?><link rel="pingback" href="" /><?php endif; ?>
...
<div id="main">
  ...
  <div id="p<?php echo context::global_filter($_ctx->posts->post_id,0,0,0,0,0,'EntryID'); ?>" class="post">
    <p class="page-info post-info"><?php echo context::global_filter($_ctx->posts->getAuthorLink(),0,0,0,0,0,'EntryAuthorLink'); ?> - <?php echo context::global_filter($_ctx->posts->getDate('',''),0,0,0,0,0,'EntryDate'); ?></p>
