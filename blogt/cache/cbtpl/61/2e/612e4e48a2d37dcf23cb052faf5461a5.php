...
@import url(<?php echo context::global_filter($core->blog->settings->system->themes_url."/".$core->blog->settings->system->theme,0,0,0,0,0,'BlogThemeURL'); ?>/style.css);
</style>
<style type="text/css" media="print">
@import url(<?php echo context::global_filter($core->blog->settings->system->themes_url."/".$core->blog->settings->system->theme,0,0,0,0,0,'BlogThemeURL'); ?>/../default/print.css);
</style>
