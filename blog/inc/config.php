...
// Database user
define('DC_DBUSER','u253249265_edaxe');

// Database password
define('DC_DBPASSWORD','uramuPehuX');

// Database name
define('DC_DBNAME','u253249265_ylese');
...
define('DC_ADMIN_URL','http://shoelbriegel.besaba.com/blog/admin/');

// Admin mail from address. For password recovery and such.
define('DC_ADMIN_MAILFROM','stephanye.tete@hotmail.com');
