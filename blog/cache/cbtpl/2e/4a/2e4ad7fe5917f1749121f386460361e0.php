...
<?php endif; ?> 
<?php echo context::global_filter($_ctx->posts->getAuthorLink(),0,0,0,0,0,'EntryAuthorLink'); ?> - <?php echo context::global_filter($_ctx->posts->getDate('',''),0,0,0,0,0,'EntryDate'); ?> - <a href="<?php echo context::global_filter($_ctx->posts->getURL(),0,0,0,0,0,'EntryURL'); ?>"><?php echo __('Permalink'); ?>
    </p>
...
<?php while ($_ctx->comments->fetch()) : ?>
    ...
    <?php endif; ?>
      ...
      href="#c<?php echo $_ctx->comments->comment_id; ?>" class="comment-number"><?php echo $_ctx->comments->index()+1; ?>.</a> <?php echo context::global_filter($_ctx->comments->getAuthorLink(),0,0,0,0,0,'CommentAuthorLink'); ?> - 
      <?php echo context::global_filter($_ctx->comments->getDate('',''),0,0,0,0,0,'CommentDate'); ?> (<?php echo context::global_filter($_ctx->comments->getTime('',''),0,0,0,0,0,'CommentTime'); ?>)
      </dt>
...
<?php while ($_ctx->pings->fetch()) : ?>
      ...
      <?php endif; ?>
        ...
        <?php if($core->blog->settings->system->comments_nofollow) { echo ' rel="nofollow"';} ?>><?php echo context::global_filter($_ctx->pings->getTrackbackTitle(),1,0,0,0,0,'PingTitle'); ?></a></p>
