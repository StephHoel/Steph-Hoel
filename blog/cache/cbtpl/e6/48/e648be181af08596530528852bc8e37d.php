...
<!--[if lt IE 9]>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo context::global_filter($core->blog->settings->system->themes_url."/".$core->blog->settings->system->theme,0,0,0,0,0,'BlogThemeURL'); ?>/ie.css" media="screen" />
<![endif]-->
