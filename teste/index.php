...
?>
					...
					<li id="cred_theme"><a href="http://www.hostinger.com" title="Web hosting">Web Hosting</a></li>
                    <li id="cred_theme"><a href="http://www.vps.me" title="VPS hosting">VPS Hosting</a></li>
				</ul>
                <?php				
				global $c_cms_code;
           		...
           		if (!empty($c_cms_code)) print " $c_cms_code ";
			?>
			</div>
		</div>
